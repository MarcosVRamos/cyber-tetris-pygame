...
class Text:
    ...
    def get_color(self):
        ...
        return n_sin(time * 2.5), n_sin(time * 1.5), n_sin(time * 3.5)

    def draw(self):
        self.font.render_to(self.app.screen, (WIN_W * 0.595, WIN_H * 0.04),
                            text='CYBER TETRIS', fgcolor=self.get_color(),
                            size=TILE_SIZE * 1.01, bgcolor='black')
        self.font.render_to(self.app.screen, (WIN_W * 0.64, WIN_H * 0.22),
                            text='proxima', fgcolor='white',
                            size=TILE_SIZE * 1.2, bgcolor='black')
        self.font.render_to(self.app.screen, (WIN_W * 0.65, WIN_H * 0.67),
                            text='pontos', fgcolor='white',
                            size=TILE_SIZE * 1.2, bgcolor='black')
